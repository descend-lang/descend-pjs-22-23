...
pub trait Visit: Sized {
    ...
    fn visit_bin_op_nat(& self, bin_op_nat: & BinOpNat) {
...
pub fn walk_ident<V: Visit>(visitor: & V, ident: & Ident) {
    //Todo: Span Nescessary?
}

pub fn walk_bin_op_nat<V:Visit>(visitor: & V, bin_op_nat: & BinOpNat) {
