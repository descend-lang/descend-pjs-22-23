...
pub trait VisitMut: Sized {
    ...
    fn visit_bin_op_nat(&mut self, bin_op_nat: &mut BinOpNat) {
...
pub fn walk_ident<V: VisitMut>(visitor: &mut V, ident: &mut Ident) {
    //Todo: Span Nescessary?
}

pub fn walk_bin_op_nat<V:VisitMut>(visitor: &mut V, bin_op_nat: &mut BinOpNat) {
