...
mkdir -p ./runs/reduce_shared_mem_cu/

SOURCE_FILE=reduce_shared_mem.cu
SOURCE_DIR=./runs/reduce_shared_mem_cu
...
do 
    ...
    do 
        ...
        nvcc $SOURCE_DIR/$SOURCE_FILE -std=c++14 -o $SOURCE_DIR/reduce_shared_mem_cu_${PLAT}_${wg}_${th}.out --extended-lambda
