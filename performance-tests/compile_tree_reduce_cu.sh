...
mkdir -p ./runs/tree_reduce_cu/

SOURCE_FILE=tree_reduce.cu
SOURCE_DIR=./runs/tree_reduce_cu
...
do 
    ...
    do 
        ...
        nvcc $SOURCE_DIR/$SOURCE_FILE -std=c++14 -o $SOURCE_DIR/tree_reduce_cu_${PLAT}_${wg}_${th}.out --extended-lambda
