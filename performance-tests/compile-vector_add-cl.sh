...
mkdir -p $SCRIPT_DIR/runs/vector_add_cl/

SOURCE_FILE=vector_add.cpp
SOURCE_DIR=$SCRIPT_DIR/runs/vector_add_cl
...
do 
    ...
    do 
        ...
        cp -r $SOURCE_DIR/$SOURCE_FILE $SOURCE_DIR/vector_add_cl_${PLAT}_${wg}_${th}.cpp
        cd $SOURCE_DIR
        cmake .
        cmake --build . --target vector_add
        mv vector_add vector_add_cl_${PLAT}_${wg}_${th}.out
